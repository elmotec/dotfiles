...
call <sid>hi("Macro",         s:cterm08, "", s:cterm08, "", "", "")
call <sid>hi("MatchParen",    "", s:cterm03, "", s:cterm03,  "", "")
call <sid>hi("ModeMsg",       s:cterm0B, "", s:cterm0B, "", "", "")
call <sid>hi("MoreMsg",       s:cterm0B, "", s:cterm0B, "", "", "")
...
call <sid>hi("Underlined",    s:cterm08, "", s:cterm08, "", "", "")
call <sid>hi("Visual",        "", s:cterm02, "", s:cterm02, "", "")
call <sid>hi("VisualNOS",     s:cterm08, "", s:cterm08, "", "", "")
call <sid>hi("WarningMsg",    s:cterm08, "", s:cterm08, "", "", "")
...
" call <sid>hi("LineNr",        s:cterm03, s:cterm00, s:cterm03, s:cterm00, "", "")
...
call <sid>hi("CursorLine",    "", s:cterm01, "", s:cterm01, "none", "")
...
call <sid>hi("Identifier",   s:cterm08, "", s:cterm08, "", "none", "")
...
call <sid>hi("Statement",    s:cterm08, "", s:cterm08, "", "", "")
...
call <sid>hi("DiffText",     s:cterm0E, s:cterm01,  s:cterm0E, s:cterm01, "", "")
